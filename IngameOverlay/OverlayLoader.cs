    ...
    class OverlayLoader
    {
        static void initial2()
        {
            ...
            else
            {
                ...
                IO.DefaultIO.WriteColor("[Overlay] Overlay will Automatic Start. Waiting for osu!...", ConsoleColor.Yellow);
            }
            //IO.DefaultIO.WriteColor("[Overlay] Overlay will Automatic Start. Waiting for loading finish.", ConsoleColor.Yellow);
